...
?>
<div style="background-color:wheat;margin-top:0px;width:100%;height:1000px;  "><br>

<div class="form1">
<form action="assess1table.php" method="POST">
ROLL NO. <br>
...
<input type="submit" name="submit" value="SUBMIT" onClick="location.href='assess1table.php'" class="input2"><br><br>
</div>
</div>
