...
?>
<div style="background-color:gainsboro;margin-top:0px;width:100%;height:1000px;  "><br><br><br>

<div class="form1">
<form action="sem1table.php" method="POST">
ROLL NO. <br>
...
<input type="submit" name="submit" value="SUBMIT" onClick="location.href='sem1table.php'" class="input2"><br><br>
</div>
</div>
